...
function(set_project_defines_all2)
    ...
    # win editor
    set_charp_config_defines(${CONFIGURATION_WIN_STANDALONE_EDITOR} ${UNITY_WIN_EDITOR_DEFINES})
    ...
    #android editor
    set_charp_config_defines(${CONFIGURATION_WIN_ANDROID_EDITOR} ${UNITY_WIN_EDITOR_DEFINES})
    ...
    #ios editor
    set_charp_config_defines(${CONFIGURATION_MAC_IOS_EDITOR} ${UNITY_MAC_EDITOR_DEFINES})
