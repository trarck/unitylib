...
namespace YH
{
    public class FindReference : EditorWindow
    {
        ...
        /// 根据脚本查找引用的对象
        /// </summary>
        [MenuItem("Assets/Find/Find Script Reference", false, 0)]
        static public void FindScriptReference()
        {
            ...
            //foreach (KeyValuePair<string, List<string>> d in dic)
            //{
        ...
        /// 查找对象引用的类型
        /// </summary>
        [MenuItem("Assets/Find/Find Object Dependencies", false, 0)]
