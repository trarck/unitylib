...
namespace YHEditor.Timeline
{
    ...
    internal class ZoomableArea
    {
            ...
            using (new EditorGUI.DisabledScope(!enableMouseInput))
            {
                ...
                if (m_HSlider)
                {
                    ...
                    else
                    {
                        ...
                        SkinUtil.PushHorizontalScrollerSkin(styles);

                        shownXMin = GUI.HorizontalScrollbar(hRangeSliderRect,
                            shownXMin, shownXRange, editorBounds.min.x, editorBounds.max.x);

                        SkinUtil.PopHorizontalScrollerSkin();
                    }
                    min = shownXMin;
                ...
                if (m_VSlider)
                {
                    if (m_UpDirection == YDirection.Positive)
                    {
                        ...
                        else
                        {
                            ...
                            SkinUtil.PushVerticalScrollerSkin(styles);
                            shownYMin = GUI.VerticalScrollbar(vRangeSliderRect,
                                shownYMin, shownYRange, -editorBounds.max.y, -editorBounds.min.y);
                            SkinUtil.PopVerticalScrollerSkin();
                        }
        ...
        void PushHorizontalScrollerSkin(GUIStyle horizontalScrollbar, GUIStyle horizontalScrollbarThumb, GUIStyle horizontalScrollbarLeftButton, GUIStyle horizontalScrollbarRightButton)
        {
            GUIStyle oldHorizontalScrollbar = GUI.skin.horizontalScrollbar;
            GUIStyle oldHorizontalScrollbarThumb = GUI.skin.horizontalScrollbar;
            GUIStyle oldHorizontalScrollbarLeftButton = GUI.skin.horizontalScrollbar;
            GUIStyle oldHorizontalScrollbarRightButton = GUI.skin.horizontalScrollbar;

            GUI.skin.horizontalScrollbar = styles.horizontalScrollbar;
            GUI.skin.horizontalScrollbarThumb = styles.horizontalMinMaxScrollbarThumb;
            GUI.skin.horizontalScrollbarLeftButton = styles.horizontalScrollbarLeftButton;
            GUI.skin.horizontalScrollbarRightButton = styles.horizontalScrollbarRightButton;
        }
