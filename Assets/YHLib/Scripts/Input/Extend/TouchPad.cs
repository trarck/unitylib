...
namespace YH.MyInput
{
    ...
    private Image m_Image;
		...
		void OnDisable()
		{
			if (InputManager.AxisExists(horizontalAxisName))
                InputManager.UnRegisterVirtualAxis(horizontalAxisName);

			if (InputManager.AxisExists(verticalAxisName))
                InputManager.UnRegisterVirtualAxis(verticalAxisName);
		}
	}
}